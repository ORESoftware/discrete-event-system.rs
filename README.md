...
The built-in registry currently includes MDP, POMDP, hybrid, equation, and
studio model citizens.
...
tool for editing, dragging, running, and exporting `des/studio/v1` JSON block
diagrams.
