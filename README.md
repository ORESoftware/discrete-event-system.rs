...
| Nonlinear, least-squares, and metaheuristic optimization | `nonlinear_optimization_models`, `advanced_optimization_models`, `external_nonlinear_reference`; Newton/BFGS Rosenbrock minimization, Gauss-Newton/Levenberg-Marquardt exponential fitting, particle swarm global benchmark search, Pareto-archive multi-objective portfolio fronts, and local SciPy/NLopt/JMetal/MOEA-style same-input reference bridges with deterministic small-model fallbacks |
