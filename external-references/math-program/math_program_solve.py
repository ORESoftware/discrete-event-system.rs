...
OPEN_SOURCE_LINEAR_CLI_SOLVERS = {"highs", "glpk", "scip", "cbc", "clp"}
LINEAR_CLI_LP_SOLVERS = COMMERCIAL_LINEAR_CLI_SOLVERS | OPEN_SOURCE_LINEAR_CLI_SOLVERS
LINEAR_CLI_MIP_SOLVERS = COMMERCIAL_LINEAR_CLI_SOLVERS | (
    OPEN_SOURCE_LINEAR_CLI_SOLVERS - {"clp"}
)
...
def solve_lp(payload: dict[str, Any], method: str) -> dict[str, Any]:
    ...
    if backend == "cli" and family in LINEAR_CLI_LP_SOLVERS:
...
def solve_mip(payload: dict[str, Any], method: str) -> dict[str, Any]:
    ...
    if backend == "cli" and family in LINEAR_CLI_MIP_SOLVERS:
        return solve_linear_cli_bridge(
