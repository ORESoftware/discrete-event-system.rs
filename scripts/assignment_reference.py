#!/usr/bin/env python3
"""Thin compatibility launcher for the Rust assignment reference."""
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default="auto",
        metavar="SOLVER",
        help="solver alias to pass through to the Rust assignment_reference binary",
    )
