#!/usr/bin/env python3
"""Thin compatibility launcher for the Rust routing reference."""
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default="auto",
        metavar="SOLVER",
        help="solver alias to pass through to the Rust routing_reference binary",
    )
    ...
    try:
        ...
        print(
            json.dumps(
                result("error", "rust:routing-reference", str(exc))
            )
        )
        return 1
