...
domain_adapter!(
    ...
    obj(vec![
        ...
        ("airDensityKgM3", num(Some(1e-9), None, None)),
        ("airDensityScale", num(Some(1e-9), None, Some(1.0))),
        ("altitudeM", num(Some(-500.0), None, Some(0.0))),
        ("airTemperatureC", num(Some(-50.0), None, Some(15.0))),
        ("pressureHpa", num(Some(1e-9), None, None)),
        ("windSpeedMps", num(Some(0.0), None, Some(0.0))),
        ("windDirectionDeg", num(None, None, Some(0.0))),
