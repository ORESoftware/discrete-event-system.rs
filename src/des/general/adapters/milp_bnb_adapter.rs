            ...
            (
                ...
                obj(
                    vec![
                        ...
                        ("lpMaxIters", num(Some(1.0), None, Some(true))),
                        ("intTol", num(Some(0.0), None, None)),
                        ("mipStart", arr(num(None, None, None))),
                        (
                            "branchRule",
                            str_enum(&["most-fractional", "first-fractional"]),
                        ),
                        ("branchPriorities", arr(num(None, None, Some(true)))),
                        ("mipGapRel", num(Some(0.0), None, None)),
                        ("mipGapAbs", num(Some(0.0), None, None)),
    ...
    fn run(&self, params: IPMIPDESParams, _runtime: &DESRuntimeConfig) -> IPMIPSolution {
        ...
        let opts = params
            ...
            .map(|o| IPMIPSolveOptions {
                ...
                lp_max_iters: o.lp_max_iters,
                int_tol: o.int_tol,
                mip_start: o.mip_start.clone(),
                branch_rule: o.branch_rule,
                branch_priorities: o.branch_priorities.clone(),
