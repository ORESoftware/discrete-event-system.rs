...
pub fn simulation_catalogue() -> Vec<(&'static str, fn())> {
    vec![
        ...
        ("main_backpropagation", crate::des::main_backpropagation::run),
        ("main_build_site", crate::des::main_build_site::run),
        ("main_calculus", crate::des::main_calculus::run),
        ("main_computer_network", crate::des::main_computer_network::run),
        ...
        ("main_electric_circuit", crate::des::main_electric_circuit::run),
        ("main_elevator", crate::des::main_elevator::run),
        ("main_elevator_highrise", crate::des::main_elevator_highrise::run),
        ("main_empirical_control", crate::des::main_empirical_control::run),
        ("main_empirical_control_report", crate::des::main_empirical_control_report::run),
        ...
        ("main_knapsack_problem", crate::des::main_knapsack_problem::run),
        ...
        ("main_monte_carlo_sim", crate::des::main_monte_carlo_sim::run),
        ...
        ("main_optimization_as_des", crate::des::main_optimization_as_des::run),
        ("main_plumbing_flow", crate::des::main_plumbing_flow::run),
        ("main_shortest_path", crate::des::main_shortest_path::run),
        ("main_shortest_path_algo", crate::des::main_shortest_path_algo::run),
        ("main_signal_processing", crate::des::main_signal_processing::run),
        ("main_simulated_annealing", crate::des::main_simulated_annealing::run),
        ("main_snowball", crate::des::main_snowball::run),
        ("main_soccer_rotation", crate::des::main_soccer_rotation::run),
        ("main_stochastic_flow_mdp", crate::des::main_stochastic_flow_mdp::run),
        ("main_stochastic_lp", crate::des::main_stochastic_lp::run),
        ("main_stochastic_sde", crate::des::main_stochastic_sde::run),
        ("main_stochastic_sde_report", crate::des::main_stochastic_sde_report::run),
        ("main_temp_control", crate::des::main_temp_control::run),
        ("main_temp_control_anim", crate::des::main_temp_control_anim::run),
...
mod tests {
    ...
    fn catalogue_is_well_formed() {
        ...
        names.dedup();
        assert_eq!(before, names.len(), "duplicate simulation names in catalogue");
    }
}
